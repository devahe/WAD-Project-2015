...
router.get('/get/json', function(req, res) {
  ...
  var obj = JSON.parse(fs.readFileSync('classifieds.json', 'utf8'));
...
router.get('/get/html', function(req, res) {
  ...
  var stylesheet = xslt.readXsltFile('classifieds.xsl');
  var doc = xslt.readXmlFile('classifieds.xml');
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    // Read in a JSON file
    var JSONfile = fs.readFileSync('classifieds.json', 'utf8');
    ...
    fs.writeFileSync('classifieds.json', JSONformated);

    // Convert the updated JSON file to XML     
    var XMLformated = js2xmlparser("classifieds", JSONformated);

    // Write the resulting XML back to the system
    fs.writeFileSync('classifieds.xml', XMLformated);
